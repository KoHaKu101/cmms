...
use App\Http\Controllers\PDF\RepairSaveFormPDFController;
//******************************* PR ***********************************
...
//*****************************************  Controller Any  *********************************************************
  ...
  Route::get('/machine/assets/machineall/{LINE?}'             ,[MachinePDFController::class,'MachinePDF']);
    Route::get('/machine/repairhistory/pdf/{UNID}'            ,[MachineHistoryRepairPDFController::class,'RepairHistory']) ->name('repairhistory.pdf');
    Route::get('/machine/systemcheck/pdf/{UNID}'              ,[MachineSystemCheckPDFController::class,'SystemCheckPdf'])  ->name('systemcheck.pdf');
    Route::get('/machine/repair/pdf/{UNID}'                   ,[MachineRepairPDFController::class,'RepairPdf'])            ->name('repair.pdf');
    Route::get('/machine/repair/savepdf/{UNID}'               ,[RepairSaveFormPDFController::class,'RepairSaveForm'])      ->name('repair.savepdf');
    ...
    Route::get('/dashboard/machinerepair/print'               ,[PDFController::class,'PDFMachineRepair'])                  ->name('dashboard.machinerepair.print');
  //Export Excel
...
Route::middleware('can:isAdminandPD')->group(function () {
  //*****************************************  PDRepairController  *********************************************************
...
Route::middleware('can:isAdminandMA')->group(function () {
  //*****************************************  MachineRepairController  *********************************************************
  ...
  Route::get('machine/manual/manuallist'                    ,[MachineManualController::class,'Index'])                ->name('manual.list');
    ...
    Route::post('machine/upload/update'                     ,[MachineManualController::class,'Update'])               ->name('upload.update');
  ...
  Route::get('machine/personal/personallist'                ,[PersonalController::class,'Index'])                     ->name('personal.list');
    ...
    Route::post('machine/personal/update/{UNID}'            ,[PersonalController::class,'Update'])                    ->name('personal.update');
  ...
  Route::get('machine/machinerank/list/{UNID?}'             ,[MachineRankTableController::class,'Index'])             ->name('machinerank.list');
    ...
    Route::post('machine/machinerank/update'                ,[MachineRankTableController::class,'Update'])            ->name('machinerank.update');
    Route::get('machine/machinerank/delete/{UNID}'          ,[MachineRankTableController::class,'Delete'])            ->name('machinerank.delete');
  //*****************************************  MachineTypeTableController  *********************************************************
  Route::get('machine/machinetypetable/list'                      ,[MachineTypeTableController::class,'Index'])                     ->name('machinetypetable.list');
    ...
    Route::post('machine/machinetypetable/update/{UNID}'          ,[MachineTypeTableController::class,'Update'])                    ->name('machinetypetable.update');
    Route::post('machine/machinetypetable/changestatus/{UNID}'    ,[MachineTypeTableController::class,'ChangeStatusButton'])        ->name('machinetypetable.changestatusbutton');
    Route::get('machine/machinetypetable/delete/{UNID}'           ,[MachineTypeTableController::class,'Delete'])                    ->name('machinetypetable.delete');
  //*****************************************  MachineSysTemTableController  *********************************************************
  ...
  Route::get('machine/mail/send'                            ,[MailConfigController::class,'Send'])            ->name('machine.config.send');
    Route::get('machine/config/home'                        ,[MailConfigController::class,'Index'])           ->name('machine.config.home');
  ...
  Route::get('machine/setting/menu/home'                    ,[MenuController::class,'Home'])                  ->name('menu.home');
    ...
    Route::get('machine/setting/menu/edit/{UNID}'           ,[MenuController::class,'Edit'])                  ->name('menu.edit');
    Route::post('machine/setting/menu/update/{UNID}'        ,[MenuController::class,'Update'])                ->name('menu.update');
    Route::get('machine/setting/menu/delete/{UNID}'         ,[MenuController::class,'Delete'])                ->name('menu.delete');
  ...
  Route::get('machine/setting/submenu/home/{UNID}'          ,[MenuSubController::class,'subhome'])            ->name('submenu.home');
    ...
    Route::get('machine/setting/submenu/edit/{UNID}'        ,[MenuSubController::class,'Edit'])               ->name('submenu.edit');
    Route::post('machine/setting/submenu/update/{UNID}'     ,[MenuSubController::class,'Update'])             ->name('submenu.update');
    Route::get('machine/setting/submenu/delete/{UNID}'      ,[MenuSubController::class,'Delete'])             ->name('submenu.delete');
  });
