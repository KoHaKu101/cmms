																								...
																								<tbody id="RESULT_SPAREPART">
																										@foreach ($SPAREPART_RESULT as $key => $sparepart)
																											<tr>
																												...
																												<td class="text-center">{{$sparepart->TOTAL_PIC}}
																													<input type="hidden" value="{{$sparepart->TOTAL_PIC}}"
																				                     id="SPAREPART_TOTAL[{{$sparepart->SPAREPART_UNID}}]" name="SPAREPART_TOTAL[{{$sparepart->SPAREPART_UNID}}]">
																				                  <input type="hidden" value="{{$sparepart->TOTAL_COST}}"
																				                     id="SPAREPART_COST[{{$sparepart->SPAREPART_UNID}}]" name="SPAREPART_COST[{{$sparepart->SPAREPART_UNID}}]">
																													 </td>
																					                  ...
																					                  data-unid="{{$sparepart->SPAREPART_UNID}}"
																					                  data-cost="{{$sparepart->SPAREPART_COST}}"
																					                  data-total="{{$sparepart->TOTAL_PIC}}"
																					                  ><i class="fas fa-edit"></i> แก้ไข</button>
																					                <button type="button" class="btn btn-sm btn-danger mx-1 my-1"
																					                  onclick="removesparepart(this)"
																					                  data-unid="{{$sparepart->SPAREPART_UNID}}" ><i class="fas fa-trash"></i> ลบ</button>
																													</td>
																											</tr>
																										@endforeach
																								</tbody>
...
@if (isset($SPAREPART_RESULT))
	@foreach ($SPAREPART_RESULT as $key => $row_sparepart)
		sparepart_total['{{$row_sparepart->SPAREPART_UNID}}'] = {{ $row_sparepart->TOTAL_PIC }}
		sparepart_cost['{{$row_sparepart->SPAREPART_UNID}}'] = {{ $row_sparepart->SPAREPART_COST }}
	@endforeach
@endif
