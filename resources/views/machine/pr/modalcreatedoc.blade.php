...
<div class="modal fade" id="NewPr" tabindex="-1" role="dialog" aria-labelledby="exampleModalLalavel" aria-hidden="true">
			...
			<div class="modal-footer" style="justify-content: space-around">
				<div class="row">
					<div class="col-md-6 ml-auto">
						<button type="button" class="btn btn-primary " id="BTN_PREVIOUS" data-previous="0" hidden><i class="fas fa-arrow-left" ></i></button>
					</div>
					<div class="col-md-6 mr-auto">
						<button type="button" class="btn btn-primary " id="BTN_NEXT" data-next="2"><i class="fas fa-arrow-right" ></i></button>
					</div>
				</div>
			</div>
		</div>
