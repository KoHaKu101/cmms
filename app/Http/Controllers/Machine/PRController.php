...
class PRController extends Controller
{
    ...
    public function TypeSelect(Request $request)
    {
        ...
        $html .= '</select>
                ...
                <div class="col-md-2">
                  <label>หน่วย</label>
                  <input type="text" class="form-control form-control-sm" id="UNIT" name="UNIT" placeholder="หน่วย">
                </div>
              </div>
              <div class="row">
    ...
    public function SaveStep2(Request $request)
    {
        ...
        $SPAREPART_UNIT = $request->UNIT;
        if ($SPAREPART_UNID != 0) {
            $Sparepart = Sparepart::selectraw('UNID,SPAREPART_NAME')->where('UNID', '=', $SPAREPART_UNID)->first();
