...
namespace App\Http\Controllers\QRCODE\lib\Qrcode\Detector;

use App\Http\Controllers\QRCODE\lib\DecodeHintType;
...
use App\Http\Controllers\QRCODE\lib\ResultPointCallback;
use App\Http\Controllers\QRCODE\lib\Common\BitMatrix;
use App\Http\Controllers\QRCODE\lib\Common\DetectorResult;
use App\Http\Controllers\QRCODE\lib\Common\GridSampler;
use App\Http\Controllers\QRCODE\lib\Common\PerspectiveTransform;
use App\Http\Controllers\QRCODE\lib\Common\Detector\MathUtils;
use App\Http\Controllers\QRCODE\lib\Qrcode\Decoder\Version;
...
class Detector
{
    ...
    protected final function processFinderPatternInfo($info)
    {
        ...
        $provisionalVersion      = \App\Http\Controllers\QRCODE\lib\Qrcode\Decoder\Version::getProvisionalVersionForDimension($dimension);
