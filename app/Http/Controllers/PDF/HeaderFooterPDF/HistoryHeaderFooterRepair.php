...
class HistoryHeaderFooterRepair extends Fpdf
{
  var $widths;
  var $aligns;
  ...
  function Header($UNID = NULL)
{
    ...
    $this->setXY(5,5);
      ...
      $this->SetFont('THSarabunNew','b',20);
        $this->Cell(248, 18, iconv('UTF-8', 'cp874', 'รายงาน ใบประวัติ เครื่องจักร / อุปกรณ์ '.$dataset->MACHINE_CODE),1,0,'C');
        $this->Cell(19, 18, iconv('UTF-8', 'cp874', ''),1,1,'C',0);
        $this->SetFont('THSarabunNew','',12);
      $this->setY(25);
        $this->Cell(22, 6, 'Machine No : ',0,0,'R',0);
      ...
      $this->setY(31);
        ...
        $this->setX(160);
          $this->Cell(23, 6, 'Supplier : ',0,0,'R',0);
